  ...
  */
  this.overlapPixel = function(pointX, pointY) {
    ...
    else
    {
      ...
      //offscreen printlning to be implemented bleurch
      return false;
    }
  };
...
function Animation(pInst) {
  ...
  */
  ...
  if(frameArguments.length === 2 && typeof frameArguments[0] === 'string' && typeof frameArguments[1] === 'string')
  {
    ...
    if(ext1 !== '.png')
    {
      pInst.printlnln('Animation error: you need to use .png files (filename '+from+')');
      from = -1;
    }
    ...
    if(ext2 !== '.png')
    {
      pInst.printlnln('Animation error: you need to use .png files (filename '+to+')');
      to = -1;
    }
